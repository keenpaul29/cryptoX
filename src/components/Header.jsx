...
const Header = ({ darkMode, setDarkMode }) => {
  ...
  return (
    <header className={`${darkMode ? 'bg-gray-800' : 'bg-gray-800'} text-white p-4 fixed top-0 left-0 right-0 z-10`}>
        ...
        <div className="flex items-center space-x-4">
          ...
          {account ? (
              ...
              {dropdownOpen && (
                <div className={`absolute right-0 mt-2 w-48 rounded-md shadow-lg ${darkMode ? 'bg-gray-700' : 'bg-white'} ring-1 ring-black ring-opacity-5`}>
                  <div className="py-1" role="menu" aria-orientation="vertical" aria-labelledby="options-menu">
                    <div className={`${darkMode ? 'text-gray-300' : 'text-gray-700'} px-4 py-2 text-sm flex items-center`}>
                    ...
                    <a
                      ...
                      className={`${darkMode ? 'text-gray-300 hover:bg-gray-600' : 'text-gray-700 hover:bg-gray-100'}  px-4 py-2 text-sm flex items-center`}
                      role="menuitem"
                    >
                    ...
                    <button
                      ...
                      className={`${darkMode ? 'text-gray-300 hover:bg-gray-600' : 'text-gray-700 hover:bg-gray-100'}  w-full text-left px-4 py-2 text-sm flex items-center`}
                      role="menuitem"
                    >
            ...
            <button
              ...
              className={`${darkMode ? 'bg-blue-600 text-white' : 'bg-white text-blue-600'} px-4 py-2 rounded-full flex items-center`}
            >
